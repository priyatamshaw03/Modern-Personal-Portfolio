    ...
    <section id="contact" className="py-16">
      ...
      >
        ...
        <motion.div className="flex-1 w-full" variants={fadeBottom}>
          ...
          <form className="flex flex-col items-center text-sm text-slate-800 mt-10 dark:text-white">
            <div className="max-w-96 w-full px-4 border-1 border-slate-300 rounded-xl p-8">
